  ...
  return (
    <div style={{
      ...
      <div style={{
        ...
        <div style={{ fontSize: 20, fontWeight: 700, color: 'var(--text)', marginBottom: 8, letterSpacing: -0.3 }}>
        ...
        <div style={{
          ...
          borderRadius: 'var(--radius-sm)', padding: '14px 16px', marginBottom: 28, textAlign: 'left',
        }}>
          <div style={{ fontSize: 11, fontWeight: 700, color: 'var(--accent)', textTransform: 'uppercase', letterSpacing: .5, marginBottom: 6 }}>
            Como obter acesso?
          </div>
          <div style={{ fontSize: 12, color: 'var(--text2)', lineHeight: 1.6 }}>
            Solicite ao administrador que gere um link de convite e envie para você.
          </div>
        </div>

        <button className="btn btn-ghost" onClick={logout} style={{ width: '100%', justifyContent: 'center', padding: '11px 18px' }}>
          Sair e usar outra conta
        </button>

        <div style={{ fontSize: 10, color: 'var(--text3)', marginTop: 24, letterSpacing: 1, fontFamily: 'DM Mono, monospace' }}>
          NEXUS MAX · CONTATTOS
        </div>
      </div>
    </div>
